...
# Lets see what happens if every year you get 100 new dollars, lotto does not redraw, and we do this for 10 years
def simulateOnce():
    town = TownOfThieves.TownOfThieves(1000, 100, 10)
    town.simulate()
